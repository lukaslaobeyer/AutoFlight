...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_Battery_t, stringdata) + ofs \
...
QT_MOC_LITERAL(4, 37, 7)
    ...
    "Battery\0navdataAvailable\0\0AFNavdata*\0"
    "navdata\0"
};
...
const QMetaObject Battery::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_Battery.data,
      qt_meta_data_Battery,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Battery.stringdata))
        return static_cast<void*>(const_cast< Battery*>(this));
    if (!strcmp(_clname, "QNavdataListener"))
        return static_cast< QNavdataListener*>(const_cast< Battery*>(this));

...
#include "../src/widgets/gallerywidget.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_GalleryWidget_t, stringdata) + ofs \
...
QT_MOC_LITERAL(2, 31, 0)
    ...
    "GalleryWidget\0thumbnailClicked\0\0"
};
...
void GalleryWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        GalleryWidget *_t = static_cast<GalleryWidget *>(_o);
        switch (_id) {
        case 0: _t->thumbnailClicked(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
const QMetaObject GalleryWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_GalleryWidget.data,
      qt_meta_data_GalleryWidget,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_GalleryWidget.stringdata))
        return static_cast<void*>(const_cast< GalleryWidget*>(this));

...
#include "../src/widgets/orientation.h"
...
struct qt_meta_stringdata_Orientation_t {
    QByteArrayData data[5];
    char stringdata[45];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    offsetof(qt_meta_stringdata_Orientation_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData) \
    )
static const qt_meta_stringdata_Orientation_t qt_meta_stringdata_Orientation = {
    {
...
QT_MOC_LITERAL(4, 41, 2)
    ...
    "Orientation\0navdataAvailable\0\0AFNavdata*\0"
    "nd\0"
};
...
const QMetaObject Orientation::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_Orientation.data,
      qt_meta_data_Orientation,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Orientation.stringdata))
        return static_cast<void*>(const_cast< Orientation*>(this));
    if (!strcmp(_clname, "QNavdataListener"))
        return static_cast< QNavdataListener*>(const_cast< Orientation*>(this));

...
#include "../src/widgets/videodisplay.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_VideoDisplay_t, stringdata) + ofs \
...
QT_MOC_LITERAL(7, 87, 2)
    },
    "VideoDisplay\0navdataAvailable\0\0"
    "AFNavdata*\0nd\0controllerInputAvailable\0"
    "ControllerInput*\0in\0"
};
...
void VideoDisplay::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->controllerInputAvailable((*reinterpret_cast< ControllerInput*(*)>(_a[1]))); break;
        default: ;
        }
    }
}
...
const QMetaObject VideoDisplay::staticMetaObject = {
    { &QGLWidget::staticMetaObject, qt_meta_stringdata_VideoDisplay.data,
      qt_meta_data_VideoDisplay,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_VideoDisplay.stringdata))

...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_Speed_t, stringdata) + ofs \
...
QT_MOC_LITERAL(4, 35, 7)
    ...
    "Speed\0navdataAvailable\0\0AFNavdata*\0"
    "navdata\0"
};
...
const QMetaObject Speed::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_Speed.data,
      qt_meta_data_Speed,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Speed.stringdata))
        return static_cast<void*>(const_cast< Speed*>(this));
    if (!strcmp(_clname, "INavdataListener"))
        return static_cast< INavdataListener*>(const_cast< Speed*>(this));

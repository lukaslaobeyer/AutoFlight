...
#include "../src/widgets/connection.h"
...
QT_MOC_LITERAL(3, 37, 26)
    ...
    "Connection\0droneConnectionRequested\0"
    "\0arduinoConnectionRequested\0"
};
...
void Connection::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->droneConnectionRequested(); break;
        case 1: _t->arduinoConnectionRequested(); break;
        default: ;
        }
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Connection::droneConnectionRequested)) {
                *result = 0;
            }
        }
        {
            typedef void (Connection::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Connection::arduinoConnectionRequested)) {
                *result = 1;
            }
        }
    }
...
void *Connection::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "INavdataListener"))
        return static_cast< INavdataListener*>(const_cast< Connection*>(this));
...
// SIGNAL 0
void Connection::droneConnectionRequested()
{
    QMetaObject::activate(this, &staticMetaObject, 0, 0);
}

// SIGNAL 1
void Connection::arduinoConnectionRequested()
{

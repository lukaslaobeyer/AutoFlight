...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_WelcomeDialog_t, stringdata) + ofs \
...
QT_MOC_LITERAL(2, 37, 0)
    ...
    "WelcomeDialog\0openGettingStartedPage\0"
    "\0"
};
...
void WelcomeDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->openGettingStartedPage(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
const QMetaObject WelcomeDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_WelcomeDialog.data,
      qt_meta_data_WelcomeDialog,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_WelcomeDialog.stringdata))

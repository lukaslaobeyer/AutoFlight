...
//!
//! QsciScintilla implements methods, Q_SIGNALS and Q_SLOTS similar to those found
...
public Q_SLOTS:
    ...
    //! the marginClicked() signal is Q_EMITted.
    //!
...
Q_SIGNALS:
    //! This signal is Q_EMITted whenever the cursor position changes.  \a line
    //! contains the line number and \a index contains the character index
    //! within the line.
    void cursorPositionChanged(int line, int index);

    //! This signal is Q_EMITted whenever text is selected or de-selected.
    ...
    //! This signal is Q_EMITted whenever the user clicks on an indicator.  \a
    ...
    //! This signal is Q_EMITted whenever the user releases the mouse on an
    ...
    //! This signal is Q_EMITted whenever the number of lines of text changes.
    void linesChanged();

    //! This signal is Q_EMITted whenever the user clicks on a sensitive margin.
    ...
    //! This signal is Q_EMITted whenever the user attempts to modify read-only
    //! text.
    //!
    //! \sa isReadOnly(), setReadOnly()
    void modificationAttempted();

    //! This signal is Q_EMITted whenever the modification state of the text
    //! changes.  \a m is true if the text has been modified.
    //!
    //! \sa isModified(), setModified()
    void modificationChanged(bool m);

    //! This signal is Q_EMITted whenever the selection changes.
    //!
    //! \sa copyAvailable()
    void selectionChanged();

    //! This signal is Q_EMITted whenever the text in the text edit changes.
    void textChanged();

    //! This signal is Q_EMITted when an item in a user defined list is activated
